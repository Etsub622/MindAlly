...
class TherapistVerifyRepoImpl implements TherapistVerifyRepository{
  ...
  @override
  Future<Either<Failure, List<TherapistVerifyEntity>>> getTherapistsToVerify()async {
  ...
  @override
  Future<Either<Failure, String>> rejectTherapist(String id, String reason) async {
    if (await networkInfo.isConnected) {
      try {
