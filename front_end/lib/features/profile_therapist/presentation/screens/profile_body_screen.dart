...
import 'package:front_end/features/profile_therapist/presentation/screens/manage_account_screen.dart';
import 'package:front_end/features/profile_therapist/presentation/screens/update_profile_screen.dart';
import 'package:front_end/features/profile_therapist/presentation/widgets/profile_about_info.dart';
import 'package:front_end/features/profile_therapist/presentation/widgets/profile_general_info_widget.dart';
import 'package:front_end/features/profile_therapist/presentation/widgets/profile_others.info.dart';


class TherapistProfilePageBody extends StatefulWidget {
  final TherapistProfileNew profile;

  const TherapistProfilePageBody({super.key, required this.profile});

  @override
  _TherapistProfilePageState createState() => _TherapistProfilePageState();
}

class _TherapistProfilePageState extends State<TherapistProfilePageBody> {
  @override
  void initState() {
    super.initState();
    context.read<TherapistProfileBloc>().add(GetTherapistLoadEvent(therapistId: widget.profile.therapistId));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<TherapistProfileBloc, GetTherapistState>(
        builder: (BuildContext context, GetTherapistState state) {
                  ...
                  child: ClipOval(
                    child: CircleAvatar(
                      ...
                      child: CachedNetworkImage(
                        ...
                        width: 60,
                        fit: BoxFit.cover,
                        imageUrl: state.therapist.profilePicture ?? "",
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ManageTherapistScreen(
