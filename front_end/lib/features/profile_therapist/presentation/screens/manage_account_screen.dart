...
import 'package:front_end/core/utils/banks.dart';
...
class ManageTherapistScreenState extends State<ManageTherapistScreen> {
  ...
  void _showPayoutBottomSheet(BuildContext context, {PayoutModel? existingPayout}) {
    ...
    int? selectedBankCode;
    if (existingPayout?.bankCode != null) {
      try {
        selectedBankCode = existingPayout!.bankCode;
        if (!banks.any((bank) => bank.code == selectedBankCode)) {
            ...
            return BlocConsumer<UpdateTherapistBloc, UpdateTherapistState>(
              listener: (context, state) {
                if (state is UpdateTherapistLoaded) {
                  print("UpdateTherapistLoaded: ${state.therapist.profilePicture}, Payout: ${state.therapist.payout?.toJson()}");
                  setState(() {
                    profilePicture = state.therapist.profilePicture ?? profilePicture;
                    payout = state.therapist.payout ?? payout;
                  ...
                  print("UpdateTherapistError: ${state.message}");
                  setState(() {
                    _isImageUploading = false;
                  });
                  ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (existingPayout?.bankCode != null && !banks.any((bank) => bank.code == selectedBankCode)) ...[
                          const SizedBox(height: 8),
                          Text(
                            'Warning: Invalid bank code "${existingPayout!.bankCode}" detected. Please select a valid bank.',
                        ...
                        TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if (value.length != selectedAcctLength) {
                              final bankName = banks.firstWhere((bank) => bank.code == selectedBankCode).name;
                        ...
                        DropdownButtonFormField<int>(
                          ...
                          onChanged: (value) {
                            setModalState(() {
                              ...
                              selectedAcctLength = banks.firstWhere((bank) => bank.code == value!).acctLength;
            ...
            return BlocConsumer<UpdateTherapistBloc, UpdateTherapistState>(
              listener: (context, updateState) {
                if (updateState is UpdateTherapistLoaded) {
                  print("UpdateTherapistLoaded: ${updateState.therapist.profilePicture}, Payout: ${updateState.therapist.payout?.toJson()}");
                  setState(() {
                    _isImageUploading = false;
                    _imageFile = null;
                  ...
                  print("UpdateTherapistError: ${updateState.message}");
                  setState(() {
                    _isImageUploading = false;
                  });
                  ScaffoldMessenger.of(context).showSnackBar(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Text(
                                        userName,
                                        style: TextStyle(fontSize: 12, color: AppColor.hexToColor("#73777F")),
                                  ...
                                  ListTile(
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Bank: ${banks.firstWhere(
                                            (bank) {
                                              try {
                                                return bank.code == payout!.bankCode;
                                              } catch (e) {
                                                return false;
                                              }
                                            },
                                            orElse: () => Bank(id: 0, name: 'Unknown Bank', acctLength: 0, code: 0),
                                          ).name}",
                                          style: TextStyle(fontSize: 12, color: AppColor.hexToColor("#73777F")),
                                        ),
                                      ],
                                  ...
                                  Align(
                                    ...
                                    child: OutlinedButton.icon(
                                      ...
                                      style: OutlinedButton.styleFrom(
                                        ...
                                        side: BorderSide(color: AppColor.hexToColor("#00538C"), width: 1),
                                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                                        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                                        textStyle: Theme.of(context).textTheme.labelLarge,
                                      ),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            ListTile(
                              trailing: SvgPicture.asset(AppImage.logoutsvg, color: Colors.red),
                              subtitle: Text(
