...
const resetPassword = async (req, res) => {
  try {
    ...
    const userModel =
      role === "admin" ? Admin : role === "patient" ? Patient : Therapist;
    ...
    if (error.name === "JsonWebTokenError") {
      console.log(userModel, hashedPassword, "COMEON NOT HERE");
...
const forgotPassword = async (req, res) => {
  try {
    ...
    const userModel =
      ...
      (await Therapist.findOne({ Email: email })) ||
    ...
    console.log(userModel, hashedPassword);
